...
namespace LCAP.HRMS.Day01Harness;
...
public static class HarnessProgram
{
    public static async Task Main(string[] args)
    {
        ...
        if (!System.Text.RegularExpressions.Regex.IsMatch(database, "^LCAP_HRMS_Day01_[A-Za-z0-9_]+$"))
            throw new ArgumentException("Only isolated Day01 test databases are accepted.");
        ...
        var token = new JwtSecurityTokenHandler().WriteToken(new JwtSecurityToken(
            ...
            claims: [new Claim("sub", "day01-integration-tester")],
        ...
        var output = Path.Combine(root, "artifacts", "day01");
        ...
        Console.WriteLine($"Day01 SQL integration host ready at http://127.0.0.1:5091; database={database}");
        await app.RunAsync();
...
{
    public const string Issuer = "https://day01.test.invalid";
