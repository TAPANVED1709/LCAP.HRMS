...
namespace LCAP.HRMS.Day02Harness;
...
public static class HarnessProgram
{
    public static async Task Main(string[] args)
    {
        ...
        if (!System.Text.RegularExpressions.Regex.IsMatch(database, "^LCAP_HRMS_Day02_[A-Za-z0-9_]+$"))
            throw new ArgumentException("Only isolated Day02 test databases are accepted.");
        ...
        var token = new JwtSecurityTokenHandler().WriteToken(new JwtSecurityToken(
            ...
            claims: [new Claim("sub", "day02-integration-tester"), new Claim("role", "SuperAdmin")],
        ...
        var output = Path.Combine(root, "artifacts", "day02");
        ...
        builder.WebHost.UseUrls("http://127.0.0.1:5092");
        ...
        {
            var claims = new List<Claim> {new("sub", "day02-role-test"),new("role",identity.Role)};
        ...
        Console.WriteLine($"Day02 SQL integration host ready at http://127.0.0.1:5092; database={database}");
        await app.RunAsync();
...
{
    public const string Issuer = "https://day02.test.invalid";
