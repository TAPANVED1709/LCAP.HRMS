...
namespace LCAP.HRMS.Day05Harness;
...
public static class HarnessProgram
{
    public static async Task Main(string[] args)
    {
        ...
        if (!System.Text.RegularExpressions.Regex.IsMatch(database, "^LCAP_HRMS_Day05_[A-Za-z0-9_]+$"))
            throw new ArgumentException("Only isolated Day05 test databases are accepted.");
        ...
        var token = new JwtSecurityTokenHandler().WriteToken(new JwtSecurityToken(
            ...
            claims: [new Claim("sub", "day05-integration-tester"), new Claim("role", "SuperAdmin")],
        ...
        var output = Path.Combine(root, "artifacts", "day05");
        ...
        {
            var claims = new List<Claim> {new("sub", "day05-role-test"),new("role",identity.Role)};
        ...
        Console.WriteLine($"Day05 SQL integration host ready at http://127.0.0.1:5095; database={database}");
        await app.RunAsync();
...
{
    public const string Issuer = "https://day05.test.invalid";
